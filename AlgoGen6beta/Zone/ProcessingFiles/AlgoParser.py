...
settings_pattern = r"\b(open|show|launch|go to|edit|change|adjust|configure|access)\b.*\b(settings?|configuration|config|menu)\b"
agent_pattern = r"\b(create|make|build|initialize|start|deploy|set up|generate|want|need|help me (create|build|make))\b.*\b(agent|bot|assistant|AI|automation|program|script)\b"
entry_titles = {
    "formal_older_men": [
    ...
    "informal_young_women": [
        "Sis", "Girl", "Queen", "Bestie", "Hun", "Shorty", "Angel"
    ],
    "neutral_men": [
        "Gent", "Fellow", "Dear"
    ],
...
2: "EN-UK", # English (United Kingdom)
3: "RU", # Russian
4: "FR", # French
5: "DE", # German
6: "ES", # Spanish
...
stop_phrases = [
    ...
    "appreciate it, you can end here",
    "end the response",
    "stop generating",
    "pause output",
    "stop execution",
